// src/business-types/events/components/EventBookingForm.jsx - Enhanced with Paystack Integration
...
const EventBookingForm = ({ apiService, adapter }) => {
  ...
  const selectedTickets = Object.values(selections).filter(
  ...
  // Don't render if no event or tickets selected
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Please provide your details to complete the booking for {event.name}
          </p>
        </div>
      </div>
