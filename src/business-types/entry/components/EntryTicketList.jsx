// src/business-types/entry/components/EntryTicketList.jsx
...
const EntryTicketList = () => {
  ...
  useEffect(() => {
    const total = adapter.calculateTotal(selections, tickets);
  ...
  }, [selections, tickets, adapter, dispatch]);
  ...
  const loadTickets = async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        (response.data.tickets || response.data).forEach((ticket) => {
  ...
  const handleNext = () => {
    if (canProceed()) {
      ...
      const selectedTickets = adapter.getSelectedTickets(selections, tickets);
      dispatch({
